...
> 1.4.6 版本之后，`explain`
>
的可视化效果进行了优化，这里展示的是新版可视化的效果，您可以在 [更新记录中查看到相关说明](https://github.com/BeardedManZhao/mathematical-expression/blob/main/update/log22_v1.4.5_1.4.6.md)
...
- 类组件：`io.github.beardedManZhao.mathematicalExpression.core.calculation.number.SingletonEquationSolvingTwo`
- 1.5.6 版本开始，本组件开发完毕，它与第一代功能一样，但其还支持编译后表达式对象的复用！
...
public class MAIN {
    ...
    public static void main(String[] args) throws WrongFormat {
        // 将 f 函数注册进来 如果期望将函数注册给 jvm 请调用 register_jvm_function
...
> 这里演示的案例 是基于 1.4.2 版本，因此您需要确保您使用的版本大于等于 1.4.2 才可以使用哦! 在 1.4.1
> 版本中的使用方式差不多，不过一些功能不被支持！
